# ======================================================================
# GSE146423: ZIKV-infected A549 — Comprehensive DEG & Enrichment
...
# ── 1. Load & Prepare ─────────────────────────────────────────────────
cnt <- read.table("GSE146423_raw_counts_GRCh38.p13_NCBI.tsv.gz",
...
cat(sprintf("
%s
  GSE146423 — COMPLETE  |  GRCh38.p13  |  DESeq2 + apeglm
%s
